...
function filterByTeam() {
    ...
    const filteredPlayers = teamFilter === 'all' ? data : data.filter(player => player.team.includes(teamFilter));
...
function initialize() {
    ...
    document.getElementById('search').addEventListener('input', searchPlayers);
